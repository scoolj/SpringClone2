...
//		assertNotNull(sessionFactory);
	...
	public void updateEmployee() {
		...
		System.out.println("Employee firstname ====> :"  + email);
	...
	private void displayEmployee(Employee temEmployee) {
		
		System.out.println(temEmployee);
	}
	...
	public void deleteEmployeeTest() {
		...
		// get an employee from the list of employee
		Employee temEmployee = theEmployees.get(0);
		
		// display the employee
		displayEmployee(temEmployee);
		
		assertNotNull(temEmployee);
		employeeDaoImpl.deleteEmployee(temEmployee.getId());
	}
